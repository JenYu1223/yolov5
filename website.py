...
from detect_bug import run, parse_opt, main
...
with tab2:
    image2 = Image.open(
        'D:/line_bot/upload_images/S__29032450.jpg')
    st.image(image2)
...
with tab4:
    image4 = Image.open(
        'D:/line_bot/upload_images/S__29040655.jpg')
    st.image(image4)
...
with tab6:
    ...
    if uploaded_file is not None:
        ...
        # 圖片的儲存路徑
        image_save_path = f'D:/line_bot/upload_images_website/{current_time}.png'
        ...
        with open('D:/line_bot/output.txt', 'r') as f:
